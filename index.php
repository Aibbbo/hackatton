...
<html>
    <head>
        ...
        <script src="<./scripts/script.css">" charset="utf-8" defer onerror="this.loaderr='y';"></script>
...
if ($result->num_rows > 0) {
   ...
   echo "<tr><td>".$row["uin"]."</td><td>".$row["full name"]."</td><td>".$row["subject"]."</td>
<td>".$row["theme"]."</td><td>".$row["email"]."</td><td>".$row["phone number"]."</td><td>".$row["full name in english"]."</td><td>".$row["project"]."</td></tr>";
    }
} else {
